...
public class CategoriaRepositoryTest {
    ...
    public void testingFindByProdutoIdReturnCategorias() {
        ...
        when(jdbcTemplate.query(eq(FIND_CATEGORIA_BY_PRODUTO_ID), any(MapSqlParameterSource.class), any(CategoriaRowMapper.class)))
                .thenReturn(listCategorias);
    ...
    public void testingFindByProdutoIdReturnEmpty() {
        ...
        final var returnCategorias = categoriaRepository.findByProdutoId(id);
        assertTrue(returnCategorias.isEmpty());
    }
